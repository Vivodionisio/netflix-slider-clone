...
export const request = [
  {
    getNewMoviesUrl: `${baseUrl}discover/movie?${API_KEY}&language=en-US&sort_by=popularity.desc&certification_country=GB&certification.gte=U&include_adult=true&include_video=true&page=1`
  },
  {
